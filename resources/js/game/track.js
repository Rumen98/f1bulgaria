...
export function projectOnTrack(track, x, z, hint = null) {
    ...
    // Прозорецът трябва да е по-широк от максималното преместване за кадър:
    // ~90 m/s при 1/60 s = 1.5 m, т.е. под една стъпка. 40 точки е с много
    // резерв и покрива дори лаг спайк.
    const window = 40;
