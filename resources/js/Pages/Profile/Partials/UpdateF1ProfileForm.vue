        ...
        <form class="mt-6 space-y-6" @submit.prevent="submit">
            <div>
                ...
                <textarea
                    ...
                    rows="3"
                    maxlength="500"
                    class="mt-1 block w-full rounded-md border-zinc-700 bg-zinc-900 text-white shadow-sm focus:border-red-500 focus:ring-red-500"
                />
            ...
            <div class="flex items-center gap-4">
                ...
                <p v-if="form.recentlySuccessful" class="text-sm text-zinc-400">Запазено.</p>
            </div>
        </form>
    </section>
</template>
