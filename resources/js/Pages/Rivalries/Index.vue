...
<template>
    ...
    <PublicLayout>
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="font-display text-2xl font-black sm:text-3xl">Велики съперничества</h1>
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            ...
            >
                <span v-if="r.is_featured" class="absolute right-3 top-3 rounded bg-red-600/20 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-red-400">Топ</span>
                <span v-else-if="r.is_custom" class="absolute right-3 top-3 rounded bg-sky-500/15 px-2 py-0.5 text-xs font-bold uppercase tracking-wide text-sky-400">Общност</span>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-display text-lg font-black text-red-600">VS</span>
        ...
        <EmptyState v-if="rivalries.length === 0">
