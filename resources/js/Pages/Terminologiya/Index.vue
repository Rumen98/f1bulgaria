...
<template>
    ...
    <PublicLayout>
        ...
        <input
            ...
            class="mb-4 w-full rounded-lg border border-zinc-800 bg-zinc-900 px-4 py-2.5 text-white placeholder-zinc-500 focus:border-red-600 focus:outline-none"
        />
        ...
        <div v-else class="grid gap-3 sm:grid-cols-2">
            <div
                ...
                class="rounded-xl border border-zinc-800 bg-zinc-900/60 p-4 scroll-mt-24"
            >
                ...
                <span class="mt-2 inline-block rounded bg-zinc-800/60 px-2 py-0.5 text-[10px] uppercase tracking-wide text-zinc-500">
