...
// Визуалната идентичност е презентационна и живее тук (както team-brands за
// отборите). Цветовете следват езика на Ф1: лилаво = pole/най-бърз сектор,
// злато = шампион, зелено = лично постижение, червено = брандът.
const ART = {
    'first-prediction': {
        emoji: '🏁',
...
const art = computed(() => ART[props.badge.slug] ?? FALLBACK);
</script>
