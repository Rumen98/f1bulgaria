...
Куизът на седмица **{{ $week }}** е готов — 10 въпроса, еднакви за всички. Точка при първия верен отговор, втори опит няма: отговаряш, събираш точки и чакаш следващия понеделник.
...
Успешна седмица! 🏁<br> Екипът на Падок
