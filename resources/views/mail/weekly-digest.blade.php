...
@if ($quiz['remaining'] > 0)
Остават ти **{{ $quiz['remaining'] }}** непокорени въпроса — всеки дава точка при първия верен отговор. [Играй кръг]({{ url('/quiz') }})
@else
...
{{--
    ...
    и чак редовният играч печели от класирането. Куизът нарочно е само
    инлайн линк по-горе — втори бутон би размил тази подредба.
--}}
@if (! $userStats)
