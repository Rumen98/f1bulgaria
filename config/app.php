...
return [
    ...
    */
    ...
    // Получател на оперативните аларми (news:health-check). Отделен от
    // отчета нарочно: отчетът е четиво за накрая на деня, алармата трябва
    // да стигне там, където ще я видиш веднага — може да е друга кутия или
    // адрес с push на телефона. При липса пада към отчета, после към
    // ADMIN_EMAIL.
    'admin_alert_email' => env('ADMIN_ALERT_EMAIL', env('ADMIN_REPORT_EMAIL', env('ADMIN_EMAIL', ''))),
