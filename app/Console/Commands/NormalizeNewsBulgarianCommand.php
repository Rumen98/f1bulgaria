...
class NormalizeNewsBulgarianCommand extends Command
{
    ...
    private const WORD_REPLACEMENTS = [
        // Каноничното изписване е в config/driver-names-bg.php: „Шарл
        // Льоклер". Наивната транслитерация дава „Леклерк", а ministral-14b
        // веднъж го преведе като нарицателното „Лекар". И трите се свеждат
        // до едно име — иначе един пилот има три правописа на един сайт.
        'Лекар' => 'Льоклер',
        'Леклерк' => 'Льоклер',
        'Леклер' => 'Льоклер',
    ];
